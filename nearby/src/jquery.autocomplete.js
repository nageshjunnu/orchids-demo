                                ...
                                // for (var i = 0; i < arr[0].length; i++) {
                                    ...
                                    // {
                                       // console.log(arr[1].distance);
                                        ...
                                        //console.log(html1);
                                        html += '<div class="row" style="cursor:pointer;" data-id="'+parseInt(removecomma)+'"><div class="col-8" ><div class="' + className + '" data-index="' + i + '" >' + formatResult(suggestion, value, i) + '</div></div><div class="col-2"><a href = "#"><i class="fa fa-map-marker" style="color: gray;margin-right: 10px;border-radius: 50%;border: 1px solid #ddd;padding: 10px;"></i></a></div><div class="col-2"><a href ="#"><i class="fas fa-globe" style="color: gray;margin-right: 10px;border-radius: 50%;border: 1px solid #ddd;padding: 10px;"></i></a>';
            ...
            var that = this,
                ...
                try{
                 ...
                 for(var i=0;i<that.suggestions.length;i++){
                        console.log(that.suggestions[i].value);
